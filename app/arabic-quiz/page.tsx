...
// ✨ New Weekly Arabic quiz questions
const QUESTIONS: QuizQuestion[] = [
  {
    id: "q1",
    arabic: "ما اسمك؟",
    transliteration: "mā ismuk?",
    question: "What are you asking someone?",
    choices: [
      "Where are you from?",
      "How are you?",
      "What is your name?",
    ...
    hint: "You say this when meeting someone for the first time.",
  },
  {
    id: "q2",
    arabic: "أنا لا أفهم",
    transliteration: "anā lā afham",
    ...
    hint: "Very useful kapag medyo mabilis mag-salita si Boss. 😅",
  },
  {
    id: "q3",
    arabic: "مستشفى",
    transliteration: "mustashfā",
    question: "If you are looking for this place, where are you going?",
    choices: [
      "The Pharmacy",
      "The Supermarket",
      "The Hospital",
  ...
  },
  {
    ...
    question: "What does this polite invitation mean?",
    choices: [
    ...
    correct: "Please, come in / Go ahead",
    hint: "Commonly used when offering someone a seat or letting them pass.",
  },
  {
    id: "q5",
    arabic: "متى؟",
    transliteration: "matā?",
    question: "What 'W' question is this?",
    choices: [
      "Who?",
      "Where?",
      "Why?",
    ...
    correct: "When?",
    hint: "Useful for asking about work shifts or meeting times.",
  },
];
